...
def clean_data(country: Optional[str] = "PT") -> None:
    """Reads the eu_life_expectancy_raw.tsv files and transforms it
    into a clean csv file having only the portuguese data.
    """
    data = pd.read_csv(
...
if __name__ == "__main__":  # pragma: no cover
    ...
    parser.add_argument("country", type=str, default='PT', nargs="?")
